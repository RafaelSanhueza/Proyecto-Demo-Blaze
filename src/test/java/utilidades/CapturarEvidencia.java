...
public class CapturarEvidencia {
	...
	public static void escribirTitutloDocumento(String nombreDocumento, String tituloEvidencia, int fontSize) throws IOException, InterruptedException {
		File fichero = new File(nombreDocumento);
		XWPFDocument docx;
